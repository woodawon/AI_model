import os
import re
os.chdir( r'C:\Users\dongg\Desktop\모듈\train.txt')
f = open('train_texts.txt', 'r', encoding='utf8')
text = f.read()
print(text)

stopwords = ['그리고', '게다가', '더욱이', '아울러', '뿐만 아니라', '동시에', '어쩌면', '실은', '이처럼', '이는', '바로', '바야흐로', '그나저나', '또는', '이같이',
